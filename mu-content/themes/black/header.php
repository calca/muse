...
<head>
		...
		<!-- favicons -->
		<link rel="icon" type="image/png" href=<?php mu_template_get_file("img/o-ico.png") ?> />
		<link rel="icon" type="image/ico" href=<?php mu_template_get_file("img/o-ico.ico") ?> />
		<link rel="shortcut icon" href=<?php mu_template_get_file("img/o-ico.png") ?> />
		<link rel="bookmark icon" href=<?php mu_template_get_file("img/o-ico.ico") ?> />
